...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","MUSIC20JBL_BOT")
# --------------------------------------------------------
...
OWNER_ID = int(getenv("OWNER_ID", 5762854642))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/moharanger/SONA",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/rainbow_vip_ch")
